##This script was lifted from Richard McElreath's github page.
##I was getting an error when trying to run the extract.prior function of his rethinking package
##After some exploration I found that the glitch was occuring at ~line 164 before one of the arguments of one of my priors 
## was of class "call" when it should have been numeric.
##I couldnt figure out why it was given this class, or how to fix it, so I added another conditional 
##if statement to catch it and now this version of of extract.priors runs fine.
             ...
             if ( m > 0 ) {
               ...
               for ( i in m:1 ) {
                 ...
                 for ( j in 1:length(pars_in) ) {
                   ...
                   ###Mean for a dnorm prior (-3) is of class call... I have no idea why.
                   ##This hack allows extract.prior to run.
                   if ( class(pars_in[[j]])=="call" ) {
                     args[[j]] <- pars_in[[j]]
                   }
